---
title: "Oficina de Fundamentos de R"
...
# O que é um algoritmo?
 - Pode ser definido com uma sequência de passos (instruções) para resolver um determinado problema.
 
Exemplo: definindo aprovações de alunos após avaliações de uma disciplina.

```{r echo=FALSE, fig.align='center', out.width="70%"}
knitr::include_graphics("img/algoritmo.jpg")
```
